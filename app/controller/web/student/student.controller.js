...
import { students, getStudent, createStudent, updateStudent, removeStudent } from '../../../service/student/student.service';
import { getStudentConfigure, saveStudentConfigure } from '../../../service/configuration/configuration.service';

const student = express.Router();

student.get('/', [pagingParse({ column: 'id', dir: 'asc' }), hasPermission(PERMISSION.CUSTOMER.READ)], (req, res, next) => {
...
student.post('/', [hasPermission(PERMISSION.CUSTOMER.CREATE)],
  (req, res, next) => {
...
student.post('/:id(\\d+)', [hasPermission(PERMISSION.CUSTOMER.UPDATE)], (req, res, next) => {
