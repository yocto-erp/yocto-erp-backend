...
} from '../../../service/student/student-monthly-fee-new.service';
...
export function initWebStudentMonthlyFeeNewController(app) {
  app.use('/api/student-monthly-fee-new', studentMonthlyFee);
}
