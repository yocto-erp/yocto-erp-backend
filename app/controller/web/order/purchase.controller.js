...
import { createOrder, getOrder, orders, removeOrder, updateOrder } from '../../../service/order/order.service';
...
purchase.post('/:id(\\d+)', [orderValidator, hasPermission(PERMISSION.ORDER.PURCHASE.UPDATE)], (req, res, next) => {
