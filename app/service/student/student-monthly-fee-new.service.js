    ...
    if (createForm && createForm.details) {
      for (let i = 0; i < createForm.details.length; i += 1) {
        ...
        await db.StudentMonthlyFee.create({
          ...
          companyId: user.companyId,
          absentDay: studentFee.absentDay || 0,
          absentDayFee: studentFee.absentDayFee || 0,
          trialDate: studentFee.trialDate || 0,
          trialDateFee: studentFee.trialDateFee || 0,
          busFee: studentFee.busFee || 0,
          debt: studentFee.debt || 0,
          mealFee: studentFee.mealFee || 0,
          otherFee: studentFee.otherFee || 0,
          otherDeduceFee: studentFee.otherDeduceFee || 0,
          remark: studentFee.remark,
          feePerMonth: studentFee.feePerMonth || 0,
          totalAmount: studentFee.totalAmount || 0,
          studentAbsentDay: studentFee.studentAbsentDay || 0,
          studentAbsentDayFee: studentFee.studentAbsentDayFee || 0,
          toMonth: to?.month,
          toYear: to?.year,
          numberOfMonths,
    ...
    try {
      for (let i = 0; i < updateForm.details.length; i += 1) {
        ...
        await studentFee.update({
          ...
          scholarFee: item.scholarFee || 0,
          studentId: item.studentId,
          absentDay: item.absentDay || 0,
          absentDayFee: item.absentDayFee || 0,
          trialDate: item.trialDate || 0,
          trialDateFee: item.trialDateFee || 0,
          busFee: item.busFee || 0,
          mealFee: item.mealFee || 0,
          otherFee: item.otherFee || 0,
          debt: item.debt || 0,
          otherDeduceFee: item.otherDeduceFee || 0,
          remark: item.remark,
          studentAbsentDay: item.studentAbsentDay || 0,
          studentAbsentDayFee: item.studentAbsentDayFee || 0,
          feePerMonth: item.feePerMonth || 0,
